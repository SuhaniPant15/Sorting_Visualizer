...
function swap(i,j)
{
    ...
    div_update(divs[j],div_sizes[j],"#3490DE");//Height update
...
function max_heapify(n,i)
{
    ...
    if(l<n && div_sizes[l]>div_sizes[largest])
    {
        if(largest!=i)
        {
            div_update(divs[largest],div_sizes[largest],"#4B6289");//Color update
        }

        largest=l;

        div_update(divs[largest],div_sizes[largest],"#3490DE");//Color update
    }
